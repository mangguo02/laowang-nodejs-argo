...
const UUID = process.env.UUID || '7d2965fb-0bab-49d5-9d6d-3b3b6fcbd3fc'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || '1x52HQPEtLkev4h2Q8';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
